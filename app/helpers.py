...
def stream_urls(row, request: Request, hevc_ok: bool = False,
    ...
    if quality == "sub" and row["sub_path"]:
        ...
        # kameraning ikkinchi oqimi ham H.265 chiqishi mumkin. Xom H.265
        # brauzerga berilsa tasvir chiqmaydi yoki birinchi kadrda qotib
        # qoladi, shuning uchun sub ham asosiy oqim bilan bir xil qoidada
        # o'giriladi. `mode` "sub" bo'lib qolaveradi: ishlamasa pleyer
        # avvalgidek asosiy oqimga o'tadi.
